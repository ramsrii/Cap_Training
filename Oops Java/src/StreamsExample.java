...
public class StreamsExample {
	...
	public static void main(String[] args) {
        ...
        Stream<String> st = StreamsExample.getRollNo(sc.nextLine());
        System.out.println("Enter the department name acronym");
        String dept = sc.nextLine();
        int result = StreamsExample.getCount(st,dept);
        if(result == 0){
	...
	public static Stream<String> getRollNo(String rollNumbers) {
